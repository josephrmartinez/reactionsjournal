    ...
    return (
        <>
            {logData.length < 5 && <div className="font-mukta flex flex-col items-center m-auto w-4/5 text-gray-700">
                <div className="font-mukta text-lg text-gray-600 font-medium text-center max-w-sm">Add five entries to start seeing insights on common reactions and communication patterns.</div>
            </div>}
